...
public class SadrzajService {
    ...
    public Sadrzaj like(SadrzajUserDTO sadrzajUserDTO) {
        ...
        Set<RegistrovaniKorisnik> lajkovali = sadrzaj.getRegistrovaniKorisniklajkovan();
        Set<RegistrovaniKorisnik> dislajkovali = sadrzaj.getRegistrovaniKorisnik();

        lajkovali.add(registrovaniKorisnik);
        dislajkovali.remove(registrovaniKorisnik);
        sadrzaj.setRegistrovaniKorisnik(dislajkovali);
        sadrzaj.setRegistrovaniKorisniklajkovan(lajkovali);
